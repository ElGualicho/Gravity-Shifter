...
| 5 | Métal / usine | Niveau type chapitre 4, mais entièrement métal | `background_steel.png`, `floor_steel.png`, `platform2.png` |
...
Le chapitre 5 reprend volontairement la structure validée du chapitre 4. Seule l'identité visuelle change : environnement métal, fond `background_steel.png`, sol `floor_steel.png`, plateformes `platform2.png`.

---

## Thèmes d'assets dans `game.js`

Le jeu utilise maintenant une table `levelThemes` pour associer chaque niveau à son background, son sol, sa plateforme et sa hauteur de sol.
...
- Accès direct aux chapitres 1 à 5 depuis le menu.
...
| `floor_clay.png` | Sol argile / été du niveau 2 |
...
| `floor_clay.png` | Sol argile disponible pour les niveaux désert / été |
| `platform1.png` | Plateformes des niveaux nature |
| `platform2.png` | Plateformes acier/glace des niveaux 4 et 5 |
...
|---|---:|---|
| `MAX_LEVEL` | `5` | Nombre total de niveaux jouables |
...
- [x] 5 niveaux jouables
- [x] Chapitre 5 métal / usine ajouté
...
- Les plateformes flottantes des niveaux 4 et 5 utilisent `platform2.png`.
